...
fn fs(input: FragmentInput) -> @location(0) vec4f {
    ...
    var filter_size: i32 = min(i32(uniforms.max_filter_size), i32(ceil(uniforms.projected_particle_constant / depth)));

    var sigma: f32 = f32(filter_size) / 3.0; 
    var two_sigma: f32 = 2.0 * sigma * sigma;
    var sigma_depth: f32 = uniforms.depth_threshold / 3.0;
