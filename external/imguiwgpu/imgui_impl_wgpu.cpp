...
struct RenderResources
{
    ...
    WGPUBindGroupLayout ImageBindGroupLayout =
        nullptr;  // Cache layout used for the image bind group. Avoids allocating unnecessary JS objects when working with WebASM
};
                                            ...
                                            FrameResources* fr)
{
    ...
    // Setup viewport
    wgpuRenderPassEncoderSetViewport(ctx,
                                     0,
                                     0,
    ...
    wgpuRenderPassEncoderSetVertexBuffer(ctx,
                                         0,
                                         fr->VertexBuffer,
                                         0,
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < draw_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                if (bind_group)
                {
                    wgpuRenderPassEncoderSetBindGroup(pass_encoder,
                                                      1,
                ...
                wgpuRenderPassEncoderDrawIndexed(pass_encoder,
                                                 pcmd->ElemCount,
                                                 1,
